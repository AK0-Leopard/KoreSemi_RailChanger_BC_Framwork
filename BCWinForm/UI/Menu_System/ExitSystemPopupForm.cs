...
namespace com.mirle.ibg3k0.bc.winform.UI.UAS
{
    public partial class ExitSystemPopupForm : Form, ILoginInfo
    {
        ...
        //建構子
        public ExitSystemPopupForm(string function_code)
        ...
        public ExitSystemPopupForm(string function_code, Boolean withDifferentAccount)
        {
            ...
            lbl_FormTitle.Text = "Exit";

            UserIDTBx.Text = BCAppConstants.LOGIN_USER_DEFAULT;

            btn_Confirm.ConfirmButton_Click += btnLogin_Click;
            btn_Cancel.CancelButton_Click += CloseBtn_Click;
        ...
        private void PwdTBx_TextChanged(object sender, EventArgs e)
        {
            if (PwdTBx.Text != "")
            {
                btn_Confirm.FocusButton();
            }
            else
            {
                btn_Confirm.Un_FocusButton();
            }
        }
