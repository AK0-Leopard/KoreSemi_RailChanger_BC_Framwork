...
{
    public class BZCLMMFRi_a1 : BaseTX
    {
        ...
        public BZCLMMFRi_a2[] fromeqp = new BZCLMMFRi_a2[1];      //       From Equipment
        public BZCLMMFRi_a3[] toeqp = new BZCLMMFRi_a3[1];        //       To Equipment
    }
}
